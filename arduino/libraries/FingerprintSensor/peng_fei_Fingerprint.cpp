...
uint8_t peng_fei_Fingerprint::loadModel(uint16_t id) {
...
uint8_t peng_fei_Fingerprint::getModel(void) {
...
uint8_t peng_fei_Fingerprint::deleteModel(uint16_t id) {
...
uint8_t peng_fei_Fingerprint::emptyDatabase(void) {
...
uint8_t peng_fei_Fingerprint::getTemplateCount(void) {
